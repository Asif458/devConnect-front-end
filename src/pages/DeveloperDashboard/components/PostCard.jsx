    ...
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 mb-6 transition-all duration-300 hover:shadow-xl hover:border-gray-200 cursor-pointer w-full">
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center space-x-4">
          <div className="w-12 h-12 rounded-full flex items-center justify-center text-lg font-semibold text-white shadow-inner overflow-hidden">
            {profilePhoto ? (
              <img
                src={profilePhoto}
                alt={name}
          ...
          <div>
            <p className="text-lg font-semibold text-gray-900 hover:text-sky-600 transition-colors">{name}</p>
      ...
      <div className="flex justify-between items-center pt-4 border-t border-gray-100">
        <div className="flex items-center space-x-6">
          <InteractionButton icon={Heart} count={likes} label="Like" />
          <InteractionButton icon={MessageCircle} count={comments} label="Comment" />
        </div>
        <button
